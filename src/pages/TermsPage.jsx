...
">
      ...
      <div className="min-h-screen flex justify-center items-start px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20 relative z-10">
        <div className="w-full max-w-4xl rounded-2xl p-6 sm:p-8 lg:p-12   backdrop-blur-lg border border-white/10 shadow-2xl">
          {/* Header Section */}
          <div className="mb-8 pb-6 border-b border-white/10">
            <h1 className=" text-white font-bold text-3xl sm:text-4xl lg:text-5xl mb-3">Terms & Conditions</h1>
            <p className="text-gray-300 text-sm sm:text-base">Effective Date: 1st January, 2025</p>
          </div>

          {/* Loading State */}
          {loading && (
            <div className="flex flex-col items-center justify-center py-20">
              <div className="w-14 h-14 border-4 border-blue-400/30 border-t-blue-400 rounded-full animate-spin mb-6"></div>
              <p className="text-black text-base">Loading terms and conditions...</p>
            </div>
          )}
          ...
          {!loading && !error && !content && (
            <div className="text-center py-20">
              ...
              <p className="text-gray-400 text-base sm:text-lg">No terms and conditions available.</p>
            </div>
          )}
        </div>
      </div>
