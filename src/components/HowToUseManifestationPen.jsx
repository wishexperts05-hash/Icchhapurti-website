...
export default function HowToUseManifestationPen() {
  ...
  const steps = [
    {
      ...
      description:
        'Be specific and detailed. Instead of "I want money," write "I am attracting $10,000 into my life with ease and joy."',
    ...
    },
    {
      ...
      description:
        "Use the same pen every single day. Consistency creates neural pathways and strengthens your belief in your manifestation.",
    ...
    },
    {
      ...
      description:
        "Every morning, spend just 5 minutes scripting your ideal life in present tense. Feel the emotions as you write.",
    ...
    },
    {
      ...
      description:
        "Keep this pen sacred. Don't use it for grocery lists or random notes. Reserve its energy exclusively for your dreams.",
    ...
    },
    {
      ...
      description:
        "Store your pen in a clean, high-vibe area—near crystals, on your altar, or in a special drawer dedicated to spiritual practice.",
    ...
    },
    {
      ...
      description:
        "Trust the universe's timing while taking inspired action. Your pen amplifies intention, but you must walk toward your dreams.",
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // mark cards visible for fade-in
      cardsRef.current.forEach((card, index) => {
        if (!card) return;
        const cardRect = card.getBoundingClientRect();
        if (cardRect.top < windowHeight * 0.8 && cardRect.bottom > 0) {
          // no visibleCards array here; just rely on activeStep for animation
        }
      });
    };
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-gradient-to-b from-slate-900 via-indigo-950 to-slate-900 py-24 overflow-hidden"
    >
      ...
      {/* Decorative sparkles */}
      <div
        className="absolute top-20 right-20 text-yellow-300 animate-bounce"
        style={{ animationDuration: "3s" }}
      >
        <Sparkles className="w-8 h-8" />
      </div>
      <div
        className="absolute bottom-40 left-20 text-pink-300 animate-bounce"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-md text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Follow these 6 powerful steps to activate your pen&apos;s
            manifestation energy and align with your highest timeline.
          </p>
        </div>

        {/* Steps container: mobile carousel + desktop 2-column */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {/* Left side – mobile carousel, desktop stacked list */}
          <div>
                ...
                {steps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div
                          className={`relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl p-6 border-2 transition-all duration-300 ${
                            isActive
                        ...
                        >
                          {isActive && (
                            <div
                              className={`absolute inset-0 bg-gradient-to-r ${step.color} opacity-20 rounded-2xl blur-xl`}
                            />
                          )}
                          ...
                          <div className="relative z-10 flex items-start gap-4">
                            <div className="flex-shrink-0">
                              ...
                              <div
                                className={`mt-2 text-center font-black text-xs ${
          ...
          <div className="lg:sticky lg:top-24 h-fit mt-8 lg:mt-0">
            <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-10 border border-white/30 shadow-2xl">
              <div
                className={`absolute inset-0 bg-gradient-to-br ${steps[activeStep].color} opacity-10 rounded-3xl animate-pulse`}
              />

              <div className="relative z-10">
                <div
                  className={`inline-flex w-24 h-24 bg-gradient-to-br ${steps[activeStep].color} rounded-2xl items-center justify-center mb-6 shadow-2xl`}
                >
                  {(() => {
                ...
                <div
                  className={`${steps[activeStep].bgColor} backdrop-blur-sm rounded-2xl p-6 border border-white/20`}
                >
