export default function HowToUseManifestation() {
  return (
    <div className="min-h-screen flex flex-col items-center px-4">
      ...
      >
        HOW TO USE THE MANIFESTATION PEN
      </h2>
      ...
      <div className="w-full max-w-7xl bg-white rounded-3xl shadow-2xl overflow-hidden mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7">
          ...
          {/* Left – Content (2/3) */}
          <div className="lg:col-span-4 p-5 lg:p-8 xl:p-10 bg-gradient-to-br from-gray-50 to-amber-50">
          ...
          {/* Right – Image (1/3) */}
          <div className="relative h-72 sm:h-80 lg:h-auto lg:col-span-3">
            <img
              src="/how_to_use.jpg"
