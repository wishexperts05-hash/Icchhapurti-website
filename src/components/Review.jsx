    ...
    "
      ...
      "
                  >
                    ...
                    <button onClick={()=>setOpenReview(true)} className="px-6 py-2 cursor-pointer rounded-full bg-blue-500 text-white text-sm font-medium hover:bg-blue-600 transition">
                      Write a review
                    </button>
                  </div>
                </div>
    ...
    "
      ...
      "
                  >
                    ...
                    <button onClick={()=>setOpenReview(true)}  className="px-6 py-2 cursor-pointer mt-2 rounded-full bg-blue-500 text-white text-sm font-medium hover:bg-blue-600 transition">
                      Write a review
                    </button>
                  </div>
                </div>
